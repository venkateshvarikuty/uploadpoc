 ...
 */
MapTo('uploadpoc/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('uploadpoc/components/separator')(SeparatorV1Component);

MapTo('uploadpoc/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('uploadpoc/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('uploadpoc/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('uploadpoc/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('uploadpoc/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('uploadpoc/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('uploadpoc/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('uploadpoc/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('uploadpoc/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('uploadpoc/components/accordion')(AccordionV1Component);
MapTo('uploadpoc/components/tabs')(TabsV1Component);
...
LazyMapTo('uploadpoc/components/teaser')(TeaserV1Component);
...
LazyMapTo('uploadpoc/components/carousel')(CarouselV1Component);
...
LazyMapTo('uploadpoc/components/text')(LazyTextModule, TextEditConfig);